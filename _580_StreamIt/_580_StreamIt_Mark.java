package Uebungen._580_StreamIt;

import java.util.ArrayList;
import java.util.Arrays;

public class _580_StreamIt_Mark {
    ...
    public static void main(String[] args) {
        ...
        a1.stream().filter(e -> e % 2 == 0 && e > 2).map(e -> e * 2).forEach(e -> System.out.print(e + " "));
        // 24 32 28
        System.out.println();

        // Aufgabe 2:
        ArrayList<String> a2 = new ArrayList<>(Arrays.asList("Peter", "Paul", "Mary", "Panos", "Jane"));
        a2.stream().filter(e -> e.contains("e")).map(String::toUpperCase).forEach(e -> System.out.print(e + " "));
        // PETER JANE
        System.out.println();
        ...
        a3.stream().filter(e -> e % 2 == 1 && e < 41).map(e -> e / 3).forEach(e -> System.out.print(e + " "));
        // 3 4 6 7
        System.out.println();
    }
}
